...
[![PhpStorm version](https://img.shields.io/badge/PhpStorm-2019.1-brightgreen.svg)](https://www.jetbrains.com/phpstorm/)
...
Feel free to use or fork this repository. Note that I use PhpStorm 2019.1. I cannot guarantee compatibility with other versions of PhpStorm.
...
OS | Location
---|---------
Windows | `C:\Users\<User name>\.PhpStorm2019.1\config`
Linux | `~/.PhpStorm2019.1/config`
OS X | `~/Library/Preferences/PhpStorm2019.1`
