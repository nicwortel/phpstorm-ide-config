...
[![PhpStorm version](https://img.shields.io/badge/PhpStorm-2018.3-brightgreen.svg)](https://www.jetbrains.com/phpstorm/)
...
Feel free to use or fork this repository. Note that I use PhpStorm 2018.3. I cannot guarantee compatibility with other versions of PhpStorm.
...
OS | Location
---|---------
Windows | `C:\Users\<User name>\.PhpStorm2018.3\config`
Linux | `~/.PhpStorm2018.3/config`
OS X | `~/Library/Preferences/PhpStorm2018.3`
